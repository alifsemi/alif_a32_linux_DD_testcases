...
/*
 * Endpoints for A32 <-> M55 HP MHU1 (6.12 Kernel)
 * txdb1 -> &mbox_m55_hp_mhu1_tx
 * rxdb1 -> &mbox_m55_hp_mhu1_rx
 */
struct rpmsg_endpoint_info ept_tx_info = {"txdb1", 0xFFFFFFFF, 0xFFFFFFFF};
struct rpmsg_endpoint_info ept_rx_info = {"rxdb1", 0xFFFFFFFF, 0xFFFFFFFF};
...
int main()
{
    ...
    printf("==========================================\n");
    printf("A32 <-> M55 HP MHU1 Test (6.12 Kernel)\n");
    printf("==========================================\n");
...
void *send_thread(void *arg)
{
    ...
    tx_payload[0] = 0xABCDABCD;  /* Different data pattern for MHU1 */
    tx_payload[1] = 0x12341234;
