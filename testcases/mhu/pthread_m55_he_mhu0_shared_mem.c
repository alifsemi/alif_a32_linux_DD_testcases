 ...
 *
 * MHU Doorbell + Shared SRAM1 corner-case test: A32 <-> M55-HE  (MHU0)
 *
...
/* ---- Shared memory constants (must match Zephyr HE side) ---- */
...
/* HE MHU0 endpoints */
#define EPT_TX_NAME       "txdb2"
#define EPT_RX_NAME       "rxdb2"
...
int main(void)
{
	...
	printf("==========================================\n");
	printf("A32 <-> M55-HE : MHU0 Corner-Case Test\n");
